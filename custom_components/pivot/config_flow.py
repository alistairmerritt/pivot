        ...
        mode_sel = selector.SelectSelector(
            selector.SelectSelectorConfig(
                options=[
                    ...
                    selector.SelectOptionDict(value=MANAGEMENT_BLUEPRINTS, label="Use blueprints"),
                    selector.SelectOptionDict(value=MANAGEMENT_NEITHER, label="Manual setup only — Pivot still runs, no files created"),
                ],
...
class PivotOptionsFlow(config_entries.OptionsFlowWithReload):
    ...
    async def async_step_banks(
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "bank_0_name": BANK_NAMES[0],
                "bank_1_name": BANK_NAMES[1],
                "bank_2_name": BANK_NAMES[2],
                "bank_3_name": BANK_NAMES[3],
            },
        )
