...
def get_number_definitions(suffix: str) -> list[dict]:
    ...
    defs.append({
        "platform": "number",
        "key": "secondary_control_value",
        "unique_id": entity_unique_id(suffix, "secondary_control_value"),
        "entity_id": entity_id("number", suffix, "secondary_control_value"),
        "name": "Secondary Control Value",
