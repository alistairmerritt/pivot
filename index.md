...
> **Note:** This site covers the technical setup for Pivot software. For a broader overview, demonstrations, and hardware extension (Pivot Dial), visit the [Pivot project page](https://madewithmerritt.com/pivot/).
